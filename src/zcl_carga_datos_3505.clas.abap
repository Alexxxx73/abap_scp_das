CLASS zcl_carga_datos_3505 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_carga_datos_3505 IMPLEMENTATION.
...
*last_changed_at       : abp_lastchange_tstmpl;
    ...
    DATA: lt_acc_categ TYPE TABLE OF ztb_acc_cat_3505,
          lt_catego    TYPE TABLE OF ztb_catego_3505,
          lt_clientes  TYPE TABLE OF ztb_cliente_3505,
          lt_clnts_lib TYPE TABLE OF ztb_cln_lib_3505,
          lt_libros    TYPE TABLE OF ztb_libros_3505.
...
******** TABLA1 ********
    ...
    DELETE FROM ztb_acc_cat_3505.
    INSERT ztb_acc_cat_3505 FROM TABLE @lt_acc_categ.
...
******** TABLA2 ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_catego_3505.
    INSERT ztb_catego_3505 FROM TABLE @lt_catego.
...
******** TABLA3 ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_cliente_3505.
    INSERT ztb_cliente_3505 FROM TABLE @lt_clientes.
...
******** TABLA4
    lt_clnts_lib = VALUE #(
    ( id_cliente = '005638984K' id_libro = '000001' vendido = 1 )
    ( id_cliente = '005638984K' id_libro = '000020' vendido = 2 )
    ( id_cliente = '005638984K' id_libro = '000021' vendido = 3 )
    ( id_cliente = '049320909Q' id_libro = '000002' vendido = 4 )
    ( id_cliente = '049573865T' id_libro = '000003' vendido = 2 )
    ( id_cliente = '203947278B' id_libro = '000004' vendido = 5 )
    ( id_cliente = '234234231T' id_libro = '000005' vendido = 2 )
    ( id_cliente = '239482309W' id_libro = '000006' vendido = 1 )
    ( id_cliente = '239482309W' id_libro = '000010' vendido = 1 )
    ( id_cliente = '276594867J' id_libro = '000007' vendido = 1 )
    ( id_cliente = '276594867J' id_libro = '000001' vendido = 3 )
    ( id_cliente = '283748858A' id_libro = '000008' vendido = 1 )
    ( id_cliente = '283748858A' id_libro = '000022' vendido = 1 )
    ( id_cliente = '324726345S' id_libro = '000009' vendido = 2 )
    ( id_cliente = '340958439D' id_libro = '000010' vendido = 1 )
    ( id_cliente = '345093450E' id_libro = '000011' vendido = 7 )
    ( id_cliente = '345838534R' id_libro = '000012' vendido = 10 )
    ( id_cliente = '345838534R' id_libro = '000003' vendido = 4 )
    ( id_cliente = '348947597P' id_libro = '000013' vendido = 11 )
    ( id_cliente = '348947597P' id_libro = '000022' vendido = 5 )
    ( id_cliente = '378458844M' id_libro = '000014' vendido = 2 )
    ( id_cliente = '423586845G' id_libro = '000015' vendido = 2 )
    ( id_cliente = '430958433A' id_libro = '000016' vendido = 20 )
    ( id_cliente = '439853453C' id_libro = '000017' vendido = 2 )
    ( id_cliente = '439853453C' id_libro = '000022' vendido = 1 )
    ( id_cliente = '439853453C' id_libro = '000001' vendido = 3 )
    ( id_cliente = '453532543O' id_libro = '000018' vendido = 2 )
    ( id_cliente = '453532543O' id_libro = '000022' vendido = 13 )
    ( id_cliente = '489632882D' id_libro = '000019' vendido = 9 )
    ( id_cliente = '540867547H' id_libro = '000020' vendido = 7 ) ).
    "Delete possible entries; insert new entries
    DELETE FROM ztb_cln_lib_3505.
    INSERT ztb_cln_lib_3505 FROM TABLE @lt_clnts_lib.
...
******** TABLA5 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    DELETE FROM ztb_libros_3505.
    INSERT ztb_libros_3505 FROM TABLE @lt_libros.
